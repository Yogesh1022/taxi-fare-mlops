...
from src.deployment.inference_api import app, PredictionRequest, BatchPredictionRequest
...
def client():
    ...
    mock_predictor.get_prediction_statistics.return_value = {
        'count': 100, 'mean': 15.0, 'std': 5.0, 'min': 5.0, 'max': 35.0,
        'median': 15.0, 'q25': 12.0, 'q75': 18.0
    }
    mock_predictor.predict_batch.return_value = (np.array([15.0, 20.0]), {
        'n_samples': 2, 'mean_prediction': 17.5, 'std_prediction': 2.5,
        'min_prediction': 15.0, 'max_prediction': 20.0
    })
