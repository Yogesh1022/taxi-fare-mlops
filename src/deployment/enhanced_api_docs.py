    ...
    ERROR_CODES = {
        400: {
            ...
            'examples': {
                ...
                'invalid_type': {
                    'error': 'fare_amount must be a number',
                    'code': 'INVALID_TYPE'
                },
                'invalid_range': {
...
class RequestResponseExamples:
    ...
    BATCH_PREDICT_RESPONSE = {
        'batch_id': 'batch_98765',
        'predictions': [
            {'prediction': 12.50, 'id': 0},
            {'prediction': 18.75, 'id': 1}
        ],
        'total_processed': 2,
        'total_failed': 0,
    ...
    def get_example(cls, endpoint: str, example_type: str = 'basic') -> Dict[str, Any]:
        ...
        examples_map = {
            ...
            '/predict/batch': {'request': cls.BATCH_PREDICT_REQUEST, 'response': cls.BATCH_PREDICT_RESPONSE},
...
class APIDocumentationGenerator:
    ...
    def generate_complete_documentation() -> Dict[str, Any]:
        ...
        schema_customizer.add_tag(
            'Explainability',
            'Get model predictions explanations using SHAP'
        )
        schema_customizer.add_tag(
            'Monitoring',
            'Model performance and system metrics'
        )
