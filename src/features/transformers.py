...
class DatetimeFeatureExtractor(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, datetime_cols=None):
        ...
        """
        self.datetime_cols = datetime_cols or ["tpep_pickup_datetime", "tpep_dropoff_datetime"]
...
class SpeedCalculator(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        if "trip_distance" in X.columns and "trip_duration_min" in X.columns:
            ...
            X["avg_speed"] = X["trip_distance"] / (
                X["trip_duration_min"] + 1
...
class CategoricalEncoder(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, categorical_cols=None):
        ...
        """
        self.categorical_cols = categorical_cols or ["store_and_fwd_flag", "payment_type"]
